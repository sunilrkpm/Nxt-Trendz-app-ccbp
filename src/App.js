    ...
    return (
      <CartContext.Provider
        value={{
          ...
          decrementOfItemQuantity: this.decrementOfItemQuantity,
          incrementOfItemQuantity: this.incrementOfItemQuantity,
        }}
      >
        <Switch>
